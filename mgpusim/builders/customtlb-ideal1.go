...
type CustomTLBIdeal1GPUBuilder struct {
	*CommonBuilder
...
// MakeCustomTLBIdeal1GPUBuilder provides a GPU builder that can builds MCM GPU.
func MakeCustomTLBIdeal1GPUBuilder() CustomTLBIdeal1GPUBuilder {
	cbp := CommonBuilder{}
	b := CustomTLBIdeal1GPUBuilder{CommonBuilder: &cbp, switchL2TLBStriping: false, usePtCaching: false}
	b.SetDefaultCommonBuilderParams()
	return b
}

func (b CustomTLBIdeal1GPUBuilder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)
...
func (b *CustomTLBIdeal1GPUBuilder) setupInterchipNetwork() {
...
func (b *CustomTLBIdeal1GPUBuilder) createRemoteAddrTransTable() *cache.HashLowModuleFinder {
...
func (b *CustomTLBIdeal1GPUBuilder) configRemoteAddressTranslationUnit(chiplet *Chiplet,
...
func (b *CustomTLBIdeal1GPUBuilder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *CustomTLBIdeal1GPUBuilder) SwitchL2TLBStriping(switchStriping bool) {
	b.switchL2TLBStriping = switchStriping
}

func (b *CustomTLBIdeal1GPUBuilder) WithCustomHSL(customHSLpmdUnits uint64) {
	b.customHSLpmdUnits = customHSLpmdUnits
}

// over riding buildCP as CustomTLB needs customHSLpmdUnits as part of CP
func (b *CustomTLBIdeal1GPUBuilder) buildCP() {
