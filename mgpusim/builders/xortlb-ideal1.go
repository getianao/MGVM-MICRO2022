...
type XORTLBIdeal1GPUBuilder struct {
	*CommonBuilder
...
// MakeXORTLBIdeal1GPUBuilder provides a GPU builder that can builds MCM GPU.
func MakeXORTLBIdeal1GPUBuilder() XORTLBIdeal1GPUBuilder {
	// TODO: should this be using new? is the object being allocated on the stack?
	cbp := CommonBuilder{}
	b := XORTLBIdeal1GPUBuilder{CommonBuilder: &cbp, switchL2TLBStriping: false, usePtCaching: false}
	b.SetDefaultCommonBuilderParams()
	return b
}

func (b XORTLBIdeal1GPUBuilder) Build(name string, id uint64) *mgpusim.GPU {
...
func (b *XORTLBIdeal1GPUBuilder) createRemoteAddrTransTable() *cache.XORLowModuleFinder {
...
func (b *XORTLBIdeal1GPUBuilder) configRemoteAddressTranslationUnit(chiplet *Chiplet,
...
func (b *XORTLBIdeal1GPUBuilder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *XORTLBIdeal1GPUBuilder) SwitchL2TLBStriping(switchStriping bool) {
	b.switchL2TLBStriping = switchStriping
}

func (b *XORTLBIdeal1GPUBuilder) UsePtCaching(ptCaching bool) {
	b.usePtCaching = ptCaching
}

func (b *XORTLBIdeal1GPUBuilder) connectMMUToL2(chiplet *Chiplet) {
...
func (b *XORTLBIdeal1GPUBuilder) buildMemBanks(chiplet *Chiplet) {
...
func (b *XORTLBIdeal1GPUBuilder) connectL2ToDRAM(chiplet *Chiplet) {
...
func (b *XORTLBIdeal1GPUBuilder) setupInterchipNetwork() {
	chipConnector := chipnetwork.NewInterChipletConnector().
		WithEngine(b.engine).
		WithSwitchLatency(0). // changed this here //720 // 180 // 360
